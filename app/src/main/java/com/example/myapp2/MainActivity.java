...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            adapter = new CustomerAdapter(this, customers) {
                ...
                public void onBindViewHolder(CustomerViewHolder holder, int position) {
                    ...
                    holder.itemView.setOnClickListener(v -> {
                        ...
                        startActivityForResult(intent, 2); // 2 for edit
                    });
                }
            };
            ...
            fabAddCustomer.setOnClickListener(v -> {
                ...
                addCustomerLauncher.launch(intent); // 1 for add (handled by CustomerActivity)
            });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 2 && resultCode == RESULT_OK) { // Edit result
            hasLoadedCustomers = false;
            loadCustomers();
